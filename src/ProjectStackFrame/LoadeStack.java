...
public class LoadeStack extends Stack<Object>
{
    
    /**
     * static method opens a file whose path is passed to it as parameter
     * and reads list of numbers from a file and push it to the stack
     * @param fileName
